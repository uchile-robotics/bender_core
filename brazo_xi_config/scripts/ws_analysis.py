...
def main():
    ...
    mgi = MoveGroupInterface("l_arm", "l_arm_block_link",None,True)  #"bender/l_shoulder_pitch_link"
    tip_link="l_wrist_pitch_link"
    ...
    goal.header.frame_id="l_arm_support_link"
    #---------------------------------------------------------------------------------------------------------------------------------------------------
    #------------------------------------------------Iterarion Params-----------------------------------------------------------------------------------
    dl=0.3 #precision en metros (0.03)
    Xmin=-0.05  #-0.05
    Xmax=0.8  #0.8
    Ymin=-0.05 #-0.4
    Ymax=0.4  #0.05

...
speech_pres("bienvenidos a nuestra nueva casa");ros::Duration(2.2).sleep();
speech_pres("el complejo de edificios Buchef ochocientos cincuenta y uno");ros::Duration(3.8).sleep();
...
speech_pres("Para los que no me conocen, soy B'ender");ros::Duration(3).sleep();
speech_pres("el robot de servicio, que desarrollaron estudiantes de la Facultad en el laboratorio de rob'otica."); ros::Duration(5).sleep();
speak_Off();
ros::Duration(1).sleep();
show_emotion("","MoveX",10);

speech_pres("Hoy estamos celebrando"); ros::Duration(0.8).sleep();show_emotion("1313");ros::Duration(1).sleep();
speech_pres("as'i que los invito a que levanten sus copas "); ros::Duration(2.7).sleep();
speech_pres("y hagamos un brindis por Buchef Poniente"); ros::Duration(2.7).sleep();
speech_pres("supongo que ya est'an listos"); ros::Duration(2.1).sleep();show_emotion("happy3");
...
speech_pres("Quiero aprovechar mis segundos de fama"); ros::Duration(2).sleep();show_emotion("surprise");
speech_pres("ya que todos ustedes me est'an mirando"); ros::Duration(3).sleep();show_emotion("happy2");
speech_pres("para felicitar y agradecer a todos los que trabajaron en este proyecto"); ros::Duration(4).sleep();
speech_pres("No puedo nombrarlos a todos"); ros::Duration(2).sleep();
...
speech_pres("a los arquitectos de A4 + Borja Huidobro"); ros::Duration(3.3).sleep();
speech_pres("a Ingevec, que construy'o este mega proyecto"); ros::Duration(3.5).sleep();
...
speech_pres("Al IDIEM por todo el gerenciamiento y la inspecci'on t'ecnica de obra."); ros::Duration(4).sleep();
speech_pres("a todo esto, ustedes eran los que hac'ian sufrir a Ingevec"); ros::Duration(3.5).sleep();
speech_pres("ji ji ji"); ros::Duration(1).sleep();
speak_Off();
ros::Duration(2).sleep();
show_emotion("","MoveX",10);

speech_pres("Tambi'en al escultor Francisco Gacit'ua"); ros::Duration(2.5).sleep(); 
speech_pres("que nos cre'o una obra que hoy vuela en nuestro jol de acceso"); ros::Duration(4.1).sleep();
speech_pres("Finalmente agradecer al mentor de esta obra"); ros::Duration(3).sleep();
speech_pres("El ex decano Francisco Brieva Rodr'iguez"); ros::Duration(2.5).sleep();
...
speech_pres("Ahora Buchef ochocientos cincuenta y uno"); ros::Duration(3).sleep();

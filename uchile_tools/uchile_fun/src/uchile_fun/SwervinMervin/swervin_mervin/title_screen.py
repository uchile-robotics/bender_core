...
class TitleScreen():
    ...
    def __init__(self):
        ...
        self.finished   = False
        self.ready      = False
        self.background = pygame.image.load(os.path.join(path+"lib", "title.png"))
        self.logo_a     = pygame.image.load(os.path.join(path+"lib", "title_swervin.png"))
        self.logo_b     = pygame.image.load(os.path.join(path+"lib", "title_mervin.png"))
        self.bg_offset  = 0
...
#rospy.loginfo(rospy.get_caller_id() + "I heard %s", Joy)
    ...
    INICIA=data.buttons[7]
    TERMINA = data.buttons[6]
/*
* File generated automatically from endpoints.hpp
*/
...
static constexpr const uint16_t json_crc = 0xC1A0;
...
enum {
    ...
    TEST_FUNCTION = 766,
    GET_ADC_VOLTAGE = 769,
    SAVE_CONFIGURATION = 772,
    ERASE_CONFIGURATION = 774,
    REBOOT = 775,
    ENTER_DFU_MODE = 776,
    GET_INTERRUPT_STATUS = 777,
    GET_DMA_STATUS = 780,
    GET_GPIO_STATES = 783,
    GET_DRV_FAULT = 785,
    CLEAR_ERRORS = 787,
    ...
    AXIS__CONFIG__CAN__MOTOR_ERROR_RATE_MS = 176,
    AXIS__CONFIG__CAN__ENCODER_ERROR_RATE_MS = 177,
    AXIS__CONFIG__CAN__CONTROLLER_ERROR_RATE_MS = 178,
    AXIS__CONFIG__CAN__SENSORLESS_ERROR_RATE_MS = 179,
    AXIS__CONFIG__CAN__ENCODER_COUNT_RATE_MS = 180,
    AXIS__CONFIG__CAN__IQ_RATE_MS = 181,
    AXIS__CONFIG__CAN__SENSORLESS_RATE_MS = 182,
    AXIS__CONFIG__CAN__BUS_VI_RATE_MS = 183,
    ...
    AXIS__CONTROLLER__CONFIG__VEL_INTEGRATOR_LIMIT = 280,
    ...
    AXIS__CONTROLLER__MOVE_INCREMENTAL = 312,
    AXIS__CONTROLLER__START_ANTICOGGING_CALIBRATION = 315,
    AXIS__CONTROLLER__REMOVE_ANTICOGGING_BIAS = 316,
    AXIS__CONTROLLER__GET_ANTICOGGING_VALUE = 318,
    ...
    AXIS__ENCODER__SET_LINEAR_COUNT = 360,
...
template<> struct endpoint_type<OSCILLOSCOPE__GET_VAL> { typedef void type; };
...
template<> struct endpoint_type<TEST_FUNCTION> { typedef void type; };
template<> struct endpoint_type<GET_ADC_VOLTAGE> { typedef void type; };
...
template<> struct endpoint_type<GET_INTERRUPT_STATUS> { typedef void type; };
template<> struct endpoint_type<GET_DMA_STATUS> { typedef void type; };
template<> struct endpoint_type<GET_GPIO_STATES> { typedef void type; };
template<> struct endpoint_type<GET_DRV_FAULT> { typedef void type; };
...
template<> struct endpoint_type<AXIS__CONFIG__CAN__MOTOR_ERROR_RATE_MS> { typedef uint32_t type; };
template<> struct endpoint_type<AXIS__CONFIG__CAN__ENCODER_ERROR_RATE_MS> { typedef uint32_t type; };
template<> struct endpoint_type<AXIS__CONFIG__CAN__CONTROLLER_ERROR_RATE_MS> { typedef uint32_t type; };
template<> struct endpoint_type<AXIS__CONFIG__CAN__SENSORLESS_ERROR_RATE_MS> { typedef uint32_t type; };
template<> struct endpoint_type<AXIS__CONFIG__CAN__ENCODER_COUNT_RATE_MS> { typedef uint32_t type; };
template<> struct endpoint_type<AXIS__CONFIG__CAN__IQ_RATE_MS> { typedef uint32_t type; };
template<> struct endpoint_type<AXIS__CONFIG__CAN__SENSORLESS_RATE_MS> { typedef uint32_t type; };
template<> struct endpoint_type<AXIS__CONFIG__CAN__BUS_VI_RATE_MS> { typedef uint32_t type; };
...
template<> struct endpoint_type<AXIS__CONTROLLER__MOVE_INCREMENTAL> { typedef void type; };
template<> struct endpoint_type<AXIS__CONTROLLER__START_ANTICOGGING_CALIBRATION> { typedef void type; };
template<> struct endpoint_type<AXIS__CONTROLLER__REMOVE_ANTICOGGING_BIAS> { typedef void type; };
template<> struct endpoint_type<AXIS__CONTROLLER__GET_ANTICOGGING_VALUE> { typedef void type; };
...
template<> struct endpoint_type<AXIS__ENCODER__SET_LINEAR_COUNT> { typedef void type; };

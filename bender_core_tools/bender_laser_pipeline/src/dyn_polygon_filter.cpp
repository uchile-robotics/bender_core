...
bender_laser_pipeline::LaserScanDynamicPolygonFilter::LaserScanDynamicPolygonFilter() {

}

bool bender_laser_pipeline::LaserScanDynamicPolygonFilter::configure() {
    up_and_running_ = true;

    bender_utils::ParameterServerWrapper psw;
    ROS_INFO("hello world");
    //psw.getParameter("footprint", _frame_out, "");
...
bool bender_laser_pipeline::LaserScanDynamicPolygonFilter::update(
...
bool bender_laser_pipeline::LaserScanDynamicPolygonFilter::inBox(tf::Point &point) {
    return
